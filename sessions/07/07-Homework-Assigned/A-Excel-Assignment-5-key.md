...
1. What was the total amount of spending on SNAP benefits for the entire U.S. in FY 2015? (SUM) $69.5 billion.
2. Which state had the largest total decrease in SNAP benefit spending between FY 2010 and FY 2015? What was the decrease? (CHANGE, SORTING) Michigan, $439.5 million.
3. Which state had the largest percentage increase in SNAP benefit spending between FY 2010 and FY 2015? What was the percentage point increase? (PERCENT CHANGE, SORTING) Nevada, 46 percent increase
4. Which state had the highest per person spending on SNAP benefits in FY 2015? (PER PERSON CALCULATION, SORTING) Hawaii, $354.38.
5. What was the national average for per person spending on SNAP benefits in FY 2015? (AVERAGE CALCULATION). If you calculate it on the total $216.45, but if we use average, it's 212.06.
6. Using the function specifically designed to calculate rank, which state was the 36th ranked in per person spending on SNAP benefits in FY 2015 (with 1st being the lowest per person spending, and 51st being the highest)? (RANK FUNCTION, SORTING). South Carolina. $247.04
7. Using the "if" function, create a new column to classify whether a state's per person spending on SNAP benefits in FY 2015 was above or below the national average. Filter out just the ones above the national average. How many states are there above the national average? (IF, SORTING, FILTERS) (Could also use a Pivot Table to do the counting) 23.
8. Of all 51 states, which state accounted for the largest share of the total national spending on SNAP benefits in FY 2015? (SHARE OF TOTAL, SORTING). California, 11 percent.
...
1.  Who is the highest paid person at the Department of Education, as measured by year-to-date gross earnings? What is the amount? What job does that person have? (FILTER, SORT) KAREN B SALMON, $235,000, State Superintendent of Schools.
2.  Who earned more money in overtime pay than anyone else in the state? Where do they work? (SORT) DALE A SMITH, State Police.
3.  Which department had the most employees who earned more money in overtime than they did in regular earnings?  How many employees in that department fell into that category? (IF, FILTER, PIVOT, SORT) DEPT OF PUB SAFETY & COR SERVS, 457.
4.  What department had the highest percentage of its employees earning $100,000 (year-to-date-gross earnings) or more? (IF, PIVOT, FILTER, SORT, PERCENTAGE) Office of People's Counsel and Subsequent Injury Fund, 31.58 percent.
5.  What department or office had the highest average annual salary? (PIVOT)
Office of People's Counsel  $75,842.11
...
Under the PIA, if the data is available they have to "immediately" give it to you, but under no circumstances should it take more than 30 days. Page 4-2.
...
Under the PIA, I have a right to get a "searchable and analyzable" copy of the data, as long as it exists in that format. Page 6-2.
...
http://www.dpscs.state.md.us/onlineservs/sor/registry-listings.shtml

2.  Describe in a few sentences why you think the page you've linked to suggests there's a database.  

There's an online tool that allows you to search by name, geography and other attributes.  There's a web database that powers this tool. The PDF link is laid out in a table, suggesting it was generated from a spreadsheet.
